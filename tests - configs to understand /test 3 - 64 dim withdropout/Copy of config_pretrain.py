config = {
    ...
    "lr": 5e-4,  # Increased: encoder was barely learning at 1e-4
    "end_lr": 1e-6,
    "num_epochs": 2301,
    ...
    "weight_decay" : 3e-4,  # Increased from 5e-5 for better regularization
    ...
    "vq_ema_decay" : 0.95,  # EMA decay for codebook updates (0.99 = standard, tracks encoder output directions)
    "patch_size": 24,
    ...
    # Loader
    "clip_grad": 3.0,  # Increased from 0.5: encoder was gradient-starved through 16 layers
    "warmup_ratio": 0.50,
    "ipe_scale": 1.25,
    ...
    "path_data" : ['./data/traffic.csv', './data/traffic.csv',
                './data/traffic.csv',
                './data/traffic.csv',
                './data/traffic.csv',
                './data/traffic.csv',
    ...
    "path_data_forcasting": ['./data/traffic.csv'],
